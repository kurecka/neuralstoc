...
TESTS = [
    ...
    },
    {
        ...
        "cmd": "python3 scripts/rsm_loop.py --spec reach_avoid --task control --prob 0.9 --initialize ppo --num_layers_p 2 --num_layers_v 2 --hidden_p 128 --hidden_v 256 --env v2pend --exp_name pend_old --no_config --plot --learner_batch_size 16k --batch_size 32k --model mlp --norm linf --ds_type all --v_lr 0.0005 --p_lr 0.00005 --lip_lambda 0.001 --train_p 3 --eps 0.01 --p_lip 4 --v_lip 15 --min_iters 0 --grid_size 32M --buffer_size 6000000 --env_dim 4 --ppo_iters 200 --continue_rsm 1 --skip_initialize --rsm_path scripts/checkpoints/pend_old_reach_avoid_loop_0.jax --smoke_test"
    },
    {
        "name": "pend_new_reach_avoid_loop_0",
        "cmd": "python3 scripts/rsm_loop.py --spec reach_avoid --task control --prob 0.99 --initialize ppo --num_layers_p 2 --num_layers_v 2 --hidden_p 128 --hidden_v 256 --env v2pend --exp_name pend_new --rollback_threshold 0.99 --min_iters 3 --train_p 3 --learner_batch_size 32k --n_local 10 --continue_rsm 1 --skip_initialize --rsm_path scripts/checkpoints/pend_new_reach_avoid_loop_0.jax --smoke_test"
    },
    {
        "name": "cavoid_old_reach_avoid_loop_0",
        "cmd": "python3 scripts/rsm_loop.py --spec reach_avoid --task control --prob 0.9 --initialize ppo --num_layers_p 2 --num_layers_v 2 --hidden_p 128 --hidden_v 256 --env v2cavoid --exp_name cavoid_old --no_config --plot --learner_batch_size 16k --batch_size 32k --model mlp --norm linf --ds_type all --v_lr 0.0005 --p_lr 0.00005 --lip_lambda 0.001 --train_p 3 --eps 0.05 --p_lip 4 --v_lip 15 --min_iters 0 --grid_size 32M --buffer_size 6000000 --env_dim 4 --ppo_iters 100 --continue_rsm 1 --skip_initialize --rsm_path scripts/checkpoints/cavoid_old_reach_avoid_loop_0.jax --smoke_test"
    },
    {
    ...
    {
        "name": "lds_old_stability_loop_0",
        "cmd": "python3 scripts/rsm_loop.py --spec stability --task control --prob 1 --initialize sac --num_layers_p 2 --num_layers_v 2 --hidden_p 256 --hidden_v 256 --env v2lds --exp_name slds_old --no_config --load_from_brax --plot --learner_batch_size 32k --batch_size 32k --model mlp --norm l1 --ds_type all --v_lr 0.0001 --p_lr 0.000001 --lip_lambda 0.001 --train_p 3 --eps 0.01 --p_lip 4 --v_lip 15 --min_iters 0 --grid_size 32M --buffer_size 6000000 --env_dim 4 --continue_rsm 1 --skip_initialize --rsm_path scripts/checkpoints/lds_old_stability_loop_0.jax --smoke_test"
    },
    {
        "name": "lds_new_stability_loop_0",
    ...
    {
        "name": "pend_old_stability_loop_0",
        "cmd": "python3 scripts/rsm_loop.py --spec stability --task control --prob 1 --initialize ppo --num_layers_p 2 --num_layers_v 2 --hidden_p 128 --hidden_v 256 --env vpend --exp_name spend_old --no_config --plot --learner_batch_size 16k --batch_size 32k --model mlp --norm linf --ds_type all --v_lr 0.0001 --p_lr 0.000001 --lip_lambda 0.001 --train_p 3 --eps 0.01 --p_lip 4 --v_lip 15 --min_iters 0 --grid_size 32M --buffer_size 6000000 --ppo_iters 200 --continue_rsm 1 --skip_initialize --rsm_path scripts/checkpoints/pend_old_stability_loop_0.jax --smoke_test"
    },
    {
        "name": "pend_new_stability_loop_0",
    ...
    {
        "name": "cavoid_new_stability_loop_0",
    ...
    {
        "name": "lds4d_new_stability_loop_0",
