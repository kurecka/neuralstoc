...
python3 scripts/rsm_loop.py --spec reach_avoid --task control --prob 0.99 --initialize ppo --num_layers_p 2 --num_layers_v 2 --hidden_p 128 --hidden_v 256 --env v2pend_100 --exp_name pend_new --rollback_threshold 0.99 --min_iters 3 --train_p 3 --learner_batch_size 32k --n_local 10
...
python3 scripts/rsm_loop.py --spec reach_avoid --task control --prob 0.95 --initialize sac --num_layers_p 2 --num_layers_v 2 --hidden_p 256 --hidden_v 256 --env vtri --exp_name tri_new --load_from_brax --rollback_threshold 0.95 --min_iters 0 --train_p 0 --learner_batch_size 8k --n_local 4
