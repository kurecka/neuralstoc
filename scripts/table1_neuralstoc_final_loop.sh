...
## Verification of Final Results (Table 1 NeuralStoc - reach avoid)
...
python3 scripts/rsm_loop.py --spec reach_avoid --task control --prob 0.99 --initialize ppo --num_layers_p 2 --num_layers_v 2 --hidden_p 128 --hidden_v 256 --env v2pend_100 --exp_name pend_new --rollback_threshold 0.99 --min_iters 3 --train_p 3 --learner_batch_size 32k --n_local 10 --continue_rsm 1 --skip_initialize --no_train --rsm_path scripts/checkpoints/pend_new_reach_avoid_loop_7.jax
